...
<body>
    <h1>My extra credit currency converter form!</h1>
            ...
            if(!empty ($name && $email && $amount && $currency && $bank)) {
                ...
                if($total >= 100) {
                    ...
                    <div class="video happy">
                        <p>I\'m a happy camper, because I have $'.$total.' American Dollars and I am going to ride a horse!!!</p>
                        <iframe width="480" height="270" src="https://www.youtube.com/embed/r7qovpFAGrQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <p><u><a id="html-checker" href="#">HTML Validation</a></u></p>
                        <p><u><a id="css-checker" href="#">CSS Validation</a></u></p>
                        <script>
                    ...
                    echo '
                    <div class="video sad">
                        <p>I\'m not happy because I have only $'.$total.' American Dollars, and it\'s Rainning Men!!!</p>
                        <iframe width="480" height="270" src="https://www.youtube.com/embed/l5aZJBLAu1E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <p><u><a id="html-checker" href="#">HTML Validation</a></u></p>
                        <p><u><a id="css-checker" href="#">CSS Validation</a></u></p>
                        <script>
                            document.getElementById("html-checker").setAttribute("href","https://validator.w3.org/nu/?doc=" + location.href);
