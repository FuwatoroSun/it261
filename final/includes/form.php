...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ;?>" method="post">
    <fieldset>
        ...
        <ul>
            <li>
                <input type="checkbox" name="genres[]" value="french" <?php if(isset($_POST['genres']) && in_array('french', $genres)) echo 'checked="checked" ';?>> French Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="chinese" <?php if(isset($_POST['genres']) && in_array('chinese', $genres)) echo 'checked="checked" ';?>> Chinese Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="japanese" <?php if(isset($_POST['genres']) && in_array('japanese', $genres)) echo 'checked="checked" ';?>> Japanese Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="indian" <?php if(isset($_POST['genres']) && in_array('indian', $genres)) echo 'checked="checked" ';?>> Indian Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="italian" <?php if(isset($_POST['genres']) && in_array('italian', $genres)) echo 'checked="checked" ';?>> Italian Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="spanish" <?php if(isset($_POST['genres']) && in_array('spanish', $genres)) echo 'checked="checked" ';?>> Spanish Cuisine
            </li>
            <li>
                <input type="checkbox" name="genres[]" value="thai" <?php if(isset($_POST['genres']) && in_array('thai', $genres)) echo 'checked="checked" ';?>> Thai Cuisine
            </li>
        </ul>
